...
final class CycleRuntimeFactoryTest extends TestCase
{
	...
	public function testCreateUsesExactDatabaseForQueryExecution(): void
	{
	...
	public function testCreateWiresCommandExecutorFromSameDatabase(): void
	{
		$database = $this->cycleDatabase();
		$runtime = (new CycleRuntimeFactory())->create($database);
