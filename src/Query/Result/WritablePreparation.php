 ...
 *
 * When prepare already compiled a place {@see RepresentationSchema} (after identity
 * planning), {@see getFetchSchema()} returns it so {@see SelectQuery} does not recompile.
 */
