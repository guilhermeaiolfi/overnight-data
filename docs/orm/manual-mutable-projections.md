...
Manual projection does not use `SelectQuery`, `SelectQuery\BindingCompiler`, or query selection normalization. Query mutable export still compiles through `SelectQuery\BindingCompiler`.
