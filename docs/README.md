...
- [`orm/representation-schema.md`](./orm/representation-schema.md): Recursive `RepresentationSchema` model, flat projection adoption, binding kinds, mapper/query/tracking boundaries, and scalar sync guardrails.
